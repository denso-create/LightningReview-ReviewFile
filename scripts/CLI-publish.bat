...
dotnet publish ..\src\ReviewFileToJsonCLI\ReviewFileToJsonCLI.csproj -o ..\src\ReviewFileToJsonCLI\bin\Release\linux-x64-publish -c Release --self-contained=true -r linux-x64 -p:PublishSingleFile=true 
...
dotnet publish ..\src\ReviewFileToJsonCLI\ReviewFileToJsonCLI.csproj -o ..\src\ReviewFileToJsonCLI\bin\Release\win-x86-publish -c Release --self-contained true -r win-x86 -p:PublishSingleFile=true 
